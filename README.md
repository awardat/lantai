...
> 版本 **0.1.1** ｜ 平台 **Windows x64**（MVP）｜ 单机部署 ｜ 无构建步骤，两步启动
...
| 配置功能 | 设置图标进入（**密码门禁**，默认 `Admin#123`，可修改）：AI 配置、API token 生成/吊销、修改密码、关于 |
...
解压 `release/lantai-0.1.1-windows-x64.zip`，运行目录内 `lantai.exe`，浏览器打开 http://127.0.0.1:8000。
